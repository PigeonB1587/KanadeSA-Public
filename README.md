...
4. 安装对应版本的组件；Translucent Image必须安装URP增量更新包并添加渲染源，如果你使用的是CN特供版本，必须修复版本检验脚本；Morden UI Pack需要修复圆形滑条组件（不是Editor脚本）
5. 将配置文件对照名字 拖入到0号场景中的循环图标组件中的 DeserializationCharacterData 组件
6. 完成后即可正常运行项目
